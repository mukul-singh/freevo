        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="row">
                    ...
                    <div class="col-10 col-sm-10 col-md-10 row pad-r0">
                        <div class="col-12">
                ...
                <div class="col-12 row pad-r0">
                    ...
                    <div class="col-12 nopad">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="info-title">ITEM DELIVERY DATE</div>
                    ...
                    <div class="col-6 col-sm-6 col-md-6 nopad">
                        <table class="check">
                            <tr>
                                <td>
                                    <input type="checkbox">
                    ...
                    <div class="col-6 col-sm-6 col-md-6 pad-r0">
                        <div class="row">
                            <div class="col-12">
                        ...
                        <br/><br/>
                        <button class="btn blue float-right">
