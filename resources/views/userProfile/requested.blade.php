@extends('userProfile')
@section('content')
<div class="visible-xs col-12 mar-b15"></div>
<?php for($i = 0; $i < 2; $i++) {?>
<div class="col-12 row box-wrap disabled">
    ...
    <div class="col-9 font-12 pad-r0">
        ...
        <div class="row col">
            <div class="line-ht15 col-12 col-sm-9 col-md-9 nopad">
                <b>ITEM PICKUP DATE</b> :  03 June 2019<br/>
                <b>SELECTED TIME SLOT</b> :  Morning<br/>
                <b>DELIVERY METHOD</b> : Local Movers
            </div>
            <div class="col-sm-3 col-md-3 hidden-xs text-right pad-r0">
